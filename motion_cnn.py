...
def main():
    ...
    data_loader = dataloader.Motion_DataLoader(
                        ...
                        num_workers=8,
                        path='/research/dept2/mli/Data/tvl1_flow/',
                        ucf_list='./UCF_list/',
                        ucf_split='01',
                        in_channel=10,
                        )
...
class Motion_CNN():
    ...
    def train_1epoch(self):
        ...
        info = {'Epoch':[self.epoch],
                'Batch Time':[np.around(batch_time.avg,3)],
                'Data Time':[np.around(data_time.avg,3)],
                'Loss':[np.around(losses.avg,5)],
                'Prec@1':[np.around(top1.avg,4)],
                'Prec@5':[np.around(top5.avg,4)],
    ...
    def validate_1epoch(self):
        ...
        info = {'Epoch':[self.epoch],
                'Batch Time':[np.around(batch_time.avg,3)],
                'Loss':[np.around(video_loss,5)],
                'Prec@1':[np.around(video_top1,3)],
                'Prec@5':[np.around(video_top5,3)]
                }
